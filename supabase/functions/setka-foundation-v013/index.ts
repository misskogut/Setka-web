...
Deno.serve(async(req:Request)=>{
 ...
 }catch(e){console.error("setka-foundation-v013",e);return json({error:"server_error",detail:String(e?.message||e),pairVersion:PAIR_VERSION},500)}
});