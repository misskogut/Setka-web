...
const TO='https://gfchgaphzhxufwdhrcis.supabase.co/functions/v1/setka-foundation-v018';
...
window.__SETKA_FOUNDATION_ROUTE_V017_LIVE__={from:FROM,to:TO,visualBase:'0.1.7',backend:'current-foundation-v018'};
})();