(() => {
  ...
  style.textContent = `.fish35-replay-canvas{position:absolute;inset:0;width:100%;height:100%;background:#000;display:none;pointer-events:none;z-index:2}`;
  ...
  function ensureOverlay(phone) {
    let canvas = phone.querySelector(".fish35-replay-canvas");
    if (!canvas) {
      canvas = document.createElement("canvas");
      canvas.className = "fish35-replay-canvas";
