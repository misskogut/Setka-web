(() => {
  ...
  function parseReplayKey(id){const s=String(id||"");if(s.startsWith("pv34free::")){const p=s.split("::");return p.length>=3?{deviceId:p[1],replayKey:s}:null}if(s.startsWith("pv34::")){const p=s.split("::");return p.length>=3?{deviceId:p[1],replayKey:s}:null}return null}
